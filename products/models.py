...
class Product(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        #     raise MaxResolutionError('Разрешение изображения больше максимального!')
        # if img.height < min_height or img.width < min_width:
        #     raise MinResolutionError('Разрешение изображения меньше минимального!')
        image = self.image
        img = Image.open(image)
...
class Notebook(Product):
    ...
    display_type = models.CharField(max_length=255, verbose_name="Тип диплея")
    processor_freq = models.CharField(max_length=255, verbose_name="Часота процессора")
    ...
    def save(self, *args, **kwargs):
        try:
            ...
            if cart_data.get('total_price__sum'):
                self.final_price = cart_data['total_price__sum']
            else:
                self.final_price = 0
...
class Customer(models.Model):
    ...
    address = models.CharField(max_length=255, verbose_name="Адреc", null=True, blank=True)
...
class Order(models.Model):
    ...
    STATUS_CHOISES = (
        ...
        (STATUS_READY, 'Заказ сформирован'),
