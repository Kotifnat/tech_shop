...
def get_cart_product(self, *args, **kwargs):
...
class DeleteFromCartView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        cart_product = get_cart_product(self, *args, **kwargs)
...
class MakeOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.success(request, 'Спасибо за заказ! Менеджер скоро свяжется с Вами')
